...
ifeq (,$(filter-out i586 x86_64,$(ARCH)))
	...
	@$(call set,LIVECD_FONTS,fonts-ttf-google-droid-sans)
	@$(call add,THE_PACKAGES,fonts-ttf-oxygen)
	@$(call add,THE_PACKAGES,fonts-ttf-oxygen-mono)
	@$(call add,THE_PACKAGES,fonts-ttf-oxygen-sans)
